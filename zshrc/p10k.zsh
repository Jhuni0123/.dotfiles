# Generated by Powerlevel10k configuration wizard on 2020-05-12 at 13:02 KST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_FOREGROUND=231
  typeset -g POWERLEVEL9K_ASDF_NODEJS_BACKGROUND=28
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  #typeset -g POWERLEVEL9K_NVM_SHOW_ON_COMMAND='node|npm|yarn|nvm'
  typeset -g POWERLEVEL9K_NVM_SHOW_ON_UPGLOB='package.json'
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=34
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_TERRAFORM_DEFAULT_FOREGROUND=63
  typeset -g POWERLEVEL9K_TERRAFORM_DEFAULT_BACKGROUND='black'
  # typeset -g POWERLEVEL9K_TERRAFORM_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Show kubecontext only when the the command you are typing invokes one of these tools.
  # Tip: Remove the next line to always show kubecontext.
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k9s|kubectl|helm|kubens|kubectx|oc|istioctl|kogito'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_ICON_BEFORE_CONTENT=true
  ...
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND='black'
  ...
  ###############################[ public_ip: public IP address ]###############################
  typeset -g POWERLEVEL9K_PUBLIC_IP_SHOW_ON_COMMAND='ip'
  # Public IP color.
